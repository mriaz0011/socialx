...
//  socialx
//
//  Created by Muhammad Riaz on 12/6/14.
//  Copyright (c) 2014 Muhammad Riaz. All rights reserved.
//
    ...
    //        println("SQLiteDB - Initialize column with type: \(type), value: \(value)")
        ...
        func asString()->String {
            switch (type) {
                ...
                case SQLITE_BLOB:
                    if let str = String(data:value as! Data, encoding:String.Encoding.utf8) {
        ...
        func description()->String {
            return "Type: \(type), Value: \(String(describing: value))"
        }
    }
